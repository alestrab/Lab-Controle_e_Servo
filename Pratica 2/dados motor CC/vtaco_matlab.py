...
data_sim = np.loadtxt('vtaco_matlab.txt')
t_sim = data_sim[:,0]
x2_sim_1 = data_sim[:,1]
x2_sim_2 = data_sim[:,2]
...
plt.plot(t_sim,x2_sim_1,color='b',label='MATLAB - Primeira Ordem',linewidth=4)
plt.plot(t_sim,x2_sim_2,color='g',label='MATLAB - Segunda Ordem',linewidth=4)
